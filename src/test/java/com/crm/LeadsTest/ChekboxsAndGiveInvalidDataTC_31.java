...
public class ChekboxsAndGiveInvalidDataTC_31 {
	@Test
	public void checkboxAndGiveInvalidDataTC_31() throws Throwable
	{
		//generate random number
				...
				Cell Invalid = ro.getCell(2);
				
				
				Cell dt = ro.getCell(5);
				String Invdt = dt.getStringCellValue();
				...
				//Invalid date
				driver.findElement(By.name("closingdate")).sendKeys(Invdt);   
