...
public class ChekboxsAndGiveValidAmountTC_32 {
	@Test
	public void checkboxAndGiveValidAmountTC_32() throws Throwable
	{
		...
		Cell Dt = ro.getCell(5);     //valid date
		String ValidDt = Dt.getStringCellValue();
		
				Cell c = ro.getCell(3);        // valid amount
		...
		driver.findElement(By.id("jscal_field_closedate")).sendKeys(ValidDt);
